...
export function buildDecisionTrail(options: AnalysisReportOptions): DecisionTrailEntry[] {
  ...
  return [
    ...
    },
    {
      ...
      evidence: isSynthetic ? "Fixed demonstration fixture" : "SHA-256 input hashes recorded below",
      status: "COMPLETE",
    },
    {
      ...
      evidence: "Controlled adapter accepted the request; failed validations stop before execution.",
      status: "COMPLETE",
    },
    {
    ...
    },
    {
      ...
      whatHappened: `${result.retained_feature_count.toLocaleString()} features were retained and evaluated in the controlled runtime.`,
    ...
    },
    {
      ...
      evidence: "Benjamini-Hochberg adjusted p-values supplied by the controlled method.",
      status: "REVIEW",
    },
    {
